...
const Dashboard = () => {
  ...
  const progressGroupExample2 = [
    { title: 'User', icon: cilUser, value: 53 },
    
  ]

  const progressGroupExample3 = [
    { title: 'verbal', percent: 56, value: '191,235' },
    { title: 'Quantative', percent: 15, value: '51,223' },
    { title: 'Reasoning', percent: 11, value: '37,564' },
    { title: 'Logical', percent: 8, value: '27,319' },
  ]
  ...
  return (
    <>
      ...
      <CRow>
        <CCol xs>
          <CCard className="mb-4">
            <CCardHeader> Exam {' & '} progress</CCardHeader>
            <CCardBody>
              <CRow>
